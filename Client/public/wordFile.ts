...
export const preparr = ["aboard", "about", "above", "across", "after", "against", "along", "amid", "among", 
"anti", "around", "as", "at", "before", 'and','is', "behind", "below", "beneath", "beside", "between", "beyond", 
"but", "by", "despite", "down", "during", "except", "excepting", "excluding", 
"following", "for", "from", "in", "inside", "into", "like", "minus", "near", "of", "off", "on", "onto", 
"opposite", "outside", "over", "past", "per", "plus", "save", "since", "than", 
...
`class BrowserHistory:
    ...
    def back(self, steps: int) -> str:
        self.i = max(steps - self.i, 0)
        return self.history[self.i]
    def forwarr(self, steps: int) -> str:
