  ...
  return (
    <div className='px-4 lg:px-20 flex flex-col'>
      ...
      <footer className='mt-auto pb-2 text-zinc-600 flex justify-center gap-8'>
        <a className='hover:text-primary hover:underline' href='https://saurabh.codes'></a>
        <a className='hover:text-primary hover:underline' href='https://github.com/saurabhje/fastcode'>Github</a>
      </footer>
    </div>
  )
}
